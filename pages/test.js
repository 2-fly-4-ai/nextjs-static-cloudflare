            ...
            <div class="flex flex-wrap lg:items-center mb-12 -mx-4">
              <div class="w-full md:w-1/2 2xl:w-5/12 px-4 mb-8 md:mb-0">
                <div class="mx-auto md:ml-0 max-w-max overflow-hidden rounded-lg">
                  <img
                    src="flex-ui-assets/images/blog-content/content-photo4.jpg"
                    alt=""
                  />
                </div>
              </div>
              <div class="w-full md:w-1/2 px-4">
                ...
                <h2 class="mb-4 text-3xl md:text-4xl lg:text-5xl leading-tight text-darkCoolGray-900 font-bold tracking-tighter">
                  How to collaborate better with your Development team?
                </h2>
                <p class="mb-8 md:mb-12 text-lg md:text-xl font-medium text-coolGray-500">
                ...
                <div class="flex items-center -mx-2">
                  ...
                  <div class="w-auto px-2">
                    <h4 class="text-base md:text-lg font-bold text-coolGray-800">
                      John Doe
                    </h4>
            ...
            <div class="flex flex-wrap -mx-4">
              <div class="w-full md:w-5/12 lg:w-4/12 xl:w-3/12 px-4 mb-8">
                <ul class="pb-6 mb-8 border-b border-coolGray-100">
                  <li class="mb-2">
                    <a
                      class="inline-block py-2 text-coolGray-400 hover:text-coolGray-500 font-semibold"
                      href="#"
                    >
                      Introduction
                    </a>
                  ...
                  <li>
                    <a
                      class="inline-block py-3 text-coolGray-400 hover:text-coolGray-500 font-semibold"
                      href="#"
                    >
                      Summary
                    </a>
                ...
                <div class="flex items-center">
                  ...
                  >
                    ...
                    <span class="ml-2 text-sm text-coolGray-500 font-medium">
                      Copy Link
                    </span>
                  </a>
                  <a
                  ...
                  <a
                    class="inline-flex h-9 w-9 items-center justify-center text-coolGray-500 border border-coolGray-200 hover:border-coolGray-300 rounded-md shadow-md transition duration-200"
                    href="#"
                  >
                    <svg
                      width="18"
              ...
              <div class="w-full md:flex-1 px-4">
                ...
                <div class="mb-6 p-6 border-l-2 border-green-500">
                  <p class="mb-4 text-xl md:text-2xl leading-tight font-medium text-coolGray-800">
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                  ...
                  <span class="text-base md:text-lg text-coolGray-400 font-medium">
                ...
                <p class="mb-8 text-base md:text-lg text-coolGray-400 font-medium">
                  <span>Non massa enim vitae duis mattis. Vel in</span>
                  <a class="hover:text-coolGray-600 underline" href="#">
                    ultricies
                  </a>
                ...
                <p class="mb-14 text-base md:text-lg text-coolGray-500">
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec
                  ullamcorper mattis lorem non. Ultrices praesent amet ipsum
                  justo massa. Eu dolor aliquet risus gravida nunc at feugiat
                  consequat purus. Non massa enim vitae duis mattis. Vel in
                ...
                <ol class="list-decimal list-inside md:px-5 text-base md:text-lg text-coolGray-500">
