  ...
  return (
    <Layout data={data} isPost>
        ...
        <div className="flex relative z-20 justify-between px-4 mx-auto max-w-screen-xl bg-white dark:bg-gray-900 rounded">
          <article className="xl:w-[828px] w-full max-w-none htmlFormat htmlFormat-sm sm:format-base lg:format-lg htmlFormat-blue dark:format-invert">
            <header className="py-12">
              <div className="px-4 mx-auto w-full max-w-screen-xl text-center">
                ...
                <h1 className="mx-auto mb-4 max-w-2xl text-2xl dark:text-white font-extrabold leading-none text-gray-900 sm:text-3xl lg:text-4xl">
                  Flowbite Blocks Tutorial - Learn how to get started with
                  custom sections using the Flowbite Blocks
                </h1>
                <p className="text-lg font-normal text-gray-500 dark:text-gray-400">
                  Before going digital, you might scribbling down some ideas in
                  a sketchbook.
                </p>
              </div>
            </header>
            ...
            <section className="mt-8 not-format">
              ...
              <form className="mb-6">
                <div className="mb-4 w-full bg-gray-50 rounded-lg border border-gray-200 dark:bg-gray-700 dark:border-gray-700">
              ...
              <article className="p-6 mb-6 text-base bg-gray-50 rounded-lg dark:bg-gray-800">
                ...
                <p className="text-gray-500 dark:text-gray-400">
                  ...
                  Thank you! But tools are just the instrumentshtmlForthe UX
              ...
              <article className="p-6 text-base bg-gray-50 rounded-lg dark:bg-gray-800">
                ...
                <p className="text-gray-500 dark:text-gray-400">
                  ThankshtmlForsharing this. I do came from the Backend
      ...
      <aside
        ...
        className="py-8 lg:py-24 bg-gray-50 dark:bg-gray-800 px-4"
      >
