        ...
        <div className="flex max-w-screen-2xl w-full ">
          ...
          <div className="flex items-center mr-auto ml-3  ">
            <Link href="/" className="flex items-center" passHref>
              <Image src={header?.siteLogoUrl} className="-mb-" alt="" width="40" height="40" />
            ...
            <a href={footer?.socialLinks[0]?.iconUrl} className="inline-flex items-center p-2 text-sm font-medium text-white  rounded-none dark:text-gray-400 hover:bg-green-400 dark:hover:bg-gray-600" passHref>
            ...
            <a href={footer?.socialLinks[1]?.iconUrl} className="inline-flex items-center p-2 text-sm font-medium text-white  rounded-none dark:text-gray-400 hover:bg-green-400 dark:hover:bg-gray-600" passHref>
            ...
            <a href={footer?.socialLinks[2]?.iconUrl} className="inline-flex items-center p-2 text-sm font-medium text-white  rounded-none dark:text-gray-400 hover:bg-green-400 dark:hover:bg-gray-600" passHref>
            ...
            <a href={footer?.socialLinks[3]?.iconUrl} className="inline-flex items-center p-2 text-sm font-medium text-white  rounded-none dark:text-gray-400 hover:bg-green-400 dark:hover:bg-gray-600" passHref>
          ...
          <div className="flex items-center">
            <ul className="flex flex-row mt-0 mr-6 space-x-20 text-sm font-medium">
              <li className="text-gray-900 dark:text-white hover:underline uppercase">
                <Link href="/dogs" className="text-gray-900 dark:text-white hover:underline uppercase" aria-current="page">Dogs</Link>
              </li>
              <li className="text-gray-900 dark:text-white hover:underline uppercase">
                <Link href="/cats" className="text-gray-900 dark:text-white hover:underline uppercase">Cats</Link>
              </li>
              <li className="text-gray-900 dark:text-white hover:underline uppercase">
                <Link href="/birds" className="text-gray-900 dark:text-white hover:underline uppercase">Birds</Link>
              </li>
              <li className="text-gray-900 dark:text-white hover:underline uppercase">
                <Link href="/small-pets" className="text-gray-900 dark:text-white hover:underline uppercase">Small Pets</Link>
              </li>
              <li className="text-gray-900 dark:text-white hover:underline uppercase">
                <Link href="/fish-aquatic-pets" className="text-gray-900 dark:text-white hover:underline uppercase">Fish & Aquatic Pets</Link>
              </li>
              <li className="text-gray-900 dark:text-white hover:underline uppercase">
                <Link href="/reptiles-amphibians" className="text-gray-900 dark:text-white hover:underline uppercase">Reptiles & Amphibians</Link>
              </li>
              <li className="text-gray-900 dark:text-white hover:underline uppercase">
