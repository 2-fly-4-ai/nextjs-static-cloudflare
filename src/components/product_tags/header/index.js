  ...
  return (
    <header className="py-12 bg-gradient-to-r from-gray-100 to-gray-300 mt-5">
      <div className="px-4 mx-auto w-full max-w-screen-xl text-center">
        {!isEmpty(data?.page?.nodes[0]?.roundupFields?.datepublished) ? (
        ...
        {!isEmpty(data?.page?.nodes[0]?.roundupFields?.hero) ? (
          <div
            ...
            dangerouslySetInnerHTML={{
              __html: sanitize(data?.page?.nodes[0]?.roundupFields?.hero ?? {}),
            }}
          />
        ) : null}
        ...
        <p className="text-gray-600 font-medium m-5">
          {!isEmpty(
            ...
            <a
              ...
              href={
                data?.page?.nodes[0]?.products?.nodes[0]?.productTaxonomies
                  ?.nodes[0].parent?.node?.parent?.node?.parent?.node?.uri
              }
            >
              {
                data?.page?.nodes[0]?.products?.nodes[0]?.productTaxonomies
          ...
          {!isEmpty(
            ...
            <a
              ...
              href={
                data?.page?.nodes[0]?.products?.nodes[0]?.productTaxonomies
                  ?.nodes[0].parent?.node?.parent?.node?.uri
              }
            >
              {
                data?.page?.nodes[0]?.products?.nodes[0]?.productTaxonomies
